...
public class PersonController {
	...
	@PostMapping(consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YAML }, produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YAML })
	@Operation(summary = "Adds a new person!", description = "Adds a new person by passing JSON, XML OR YML", 
	tags = { "People" },
	responses = {
			@ApiResponse(description = "Success!", responseCode = "200", 
					content = @Content(schema = @Schema(implementation = PersonVO.class))
	...
	@PutMapping(consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YAML }, produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YAML })
	@Operation(summary = "Updates a new person!", description = "Updates a new person by passing JSON, XML OR YML", 
	tags = { "People" },
	responses = {
	...
	@Operation(summary = "Deletes a  person!", description = "Deletes a person by passing JSON, XML OR YML", 
	tags = { "People" },
	responses = {			
			@ApiResponse(description = "No content!", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
